...
namespace OFG.ChessPeak
{
    ...
    {
        [SerializeField] private GameObject KingDeath;
        ...
        public bool TryMakeTurn(out bool isPate)
        {
            ...
            else
            {
                ...
                if (IsCellUnderAtack(atackedCells,_kingPosition))
                {
                    GameObject k =Instantiate(KingDeath);
                    k.transform.position = _king.transform.position + new Vector3(0, 1,0);
                ...
                {
                    GameObject k = Instantiate(KingDeath);
                    k.transform.position = _king.transform.position;
                    _king.gameObject.SetActive(false);
                    _king.View.Defeat();
                    return false;
                }
